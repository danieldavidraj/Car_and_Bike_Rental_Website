<html>
	...
	<body>
        ...
        <img src="images/event.jpeg" style="height:auto;width:43%;margin-left:60px;" align="left"></div>
		<div class="break" ><img src="images/event.jpeg" style="height:auto;margin-left:10%;margin-right:10%;margin-top:1%;" align="left"><br></div>
		<script>
        ...
        <h1 style="font-size:1.6vw;margin:0 0 0 50%;">CONFERANCE AND BOARED MEETINGS</h1>
       	<p class="main" style="margin:2% 0 0 50%;">
            ...
            While customer is traveling with us we care the all needs of our clients and we also provides following items to them:-
            <br><br>
            Newspaper<br>
            water bottle<br>
